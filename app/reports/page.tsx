      ...
      <div className="card">
        ...
        <div className="card-body flush">
          {REPORT_TEMPLATES.map((r, i) => (
            <div key={r.id} style={{ padding: '14px 18px', borderBottom: i < REPORT_TEMPLATES.length - 1 ? '1px solid var(--line)' : 'none', display: 'flex', alignItems: 'center', gap: 14 }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <button className="btn sm ghost"><Icons.Download /> Export</button>
